...
include "koneksi.php";
 ...
 $query = "SELECT * FROM kategori"; // Query untuk menampilkan semua data 
...
<form action="simpantambahkategori.php" method="post" name="form2" enctype="multipart/form-data" />
<table border="0" align="center">


<tr>
<td><input type="text" name="idKategori" value="" hidden=" "/></td>
</tr>
<tr>
    <td><p>Nama kategori</p></td>
    <td><p>:</p></td>
    <td><p><input class="form-control" type="text" name="namaKategori" size="20"  /></p></td>
</tr>
<tr>
    <td><p>Keterangan</p></td>
    <td><p>:</p></td>
      <td><p><textarea class="form-control" type="text" name="ketKategori" size="20"></textarea></p></td>
</tr>
