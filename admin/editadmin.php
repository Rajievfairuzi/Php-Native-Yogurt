...
?>
<form method="post" action="simpaneditadmin.php?idAdmin=<?php echo $idAdmin; ?>" enctype="multipart/form-data">
<table border="0" align="center">
<tr valign="middle">

<tr>
<td><input type="text" name="idAdmin" value="<?php echo "$hasil[idAdmin]";?>" hidden=" "/></td>
</tr>
<tr>
<td>Nama</td>
<td>:</td>
<td><input class="form-control" type="text" name="namaAdmin" size="30" value="<?php echo "$hasil[namaAdmin]";?>"/></td>
</tr>
<td>Username</td>
<td>:</td>
<td><input class="form-control" type="text" name="username" size="30" value="<?php echo "$hasil[username]";?>"/></td>
</tr>
<td>Password</td>
<td>:</td>
<td><input class="form-control" type="text" name="password" size="30" value="<?php echo "$hasil[password]";?>"/></td>
</tr>
