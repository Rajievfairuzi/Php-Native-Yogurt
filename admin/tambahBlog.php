...
include "koneksi.php";
 ...
 $query = "SELECT * FROM blog"; // Query untuk menampilkan semua data 
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           ...
           <nav class="navbar navbar-default">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Data Blog</h1>
                </div>
...
<form action="simpanTambahBlog.php" method="post" name="form2" enctype="multipart/form-data" />
<table border="0" align="center">


<tr>
<td><input type="text" name="idBlog" value="" hidden=" "/></td>
</tr>
<tr>
    <td><p>Judul Blog</p></td>
    <td><p>:</p></td>
    <td><p><input class="form-control" type="text" name="judulBlog" size="20"  /></p></td>
</tr>
<tr>
    <td><p>Isi Blog</p></td>
    <td><p>:</p></td>
      <td><p><textarea class="form-control" type="text" name="isiBlog" size="20"></textarea></p></td>
</tr>
<tr>
<td><input type="text" name="tglBlog" value="" hidden=" "/></td>
</tr>
<tr>
    <td><p>Foto</p></td>
    <td><p>:</p></td>
    <td><p><input type="file" name="fotoBlog"  /></p></td>
</tr>
