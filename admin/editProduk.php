...
<form method="post" action="simpanEditProduk.php?idProduk=<?php echo $idProduk; ?>" enctype="multipart/form-data">
<table border="0" align="center">
<tr valign="middle">
<tr>
<td><input type="text" name="idProduk" value="<?php echo "$hasil[idProduk]";?>" hidden=" "/></td>
</tr>
<tr>
    ...
    <td> <?php
    include"koneksi.php";   
    $query = "SELECT idKategori FROM kategori "; // Query untuk menampilkan semua data siswa
    $sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
    echo"<select name='idKategori'>";
    while($a = mysqli_fetch_array($sql)){
        echo"<option value = $a[idKategori] selected>$a[idKategori]</option>";
    }echo"</selected>";?>
    </td>
</tr>
...
<td>Nama Produk </td>
<td>:</td>
<td><input class="form-control" type="text" name="namaProduk" size="30" value="<?php echo "$hasil[namaProduk]";?>"/></td>
</tr>
<tr>
<td>Keterangan </td>
<td>:</td>
<td><textarea class="form-control" name="ketProduk"><?php echo "$hasil[ketProduk]";?></textarea></td>
</tr>
<tr>
<td>Gambar</td>
<td>:</td>
<td><input class="form-control" type="file" name="fotoProduk" size="30" value="<?php echo "$hasil[fotoProduk]";?>"/></td>
...
<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
<form action="tampilProduk.php" name="back" method="post">
    <td><p>
