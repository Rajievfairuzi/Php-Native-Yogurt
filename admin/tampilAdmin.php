        ...
        <div id="page-wrapper">
           ...
           <nav class="navbar navbar-default">
            ...
            <div class="row">
                ...
                <form action="tambahadmin.php" name="gabungan" method="post">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                while ( $hasil = mysqli_fetch_array ($sql)) {
                    $idAdmin = stripslashes ($hasil['idAdmin']);
                     $namaAdmin = stripslashes ($hasil['namaAdmin']);
                    ...
                    
                    {
                        ...
                        <tr align="center" bgcolor="#ffffff" class="style5">
                            ...
                            <td><?=$idAdmin?><div align="center"></div></td>
                            <td><?=$namaAdmin?><div align="center"></div></td>
                            <td><?=$username?><div align="center"></div></td>
                          
                            <td><?=md5($password)?><div align="center"></div></td>
                          
                            <td bgcolor=" #ffffff"><div align="center"> <a class="btn btn-info" href="editadmin.php?idAdmin=<?=$idAdmin?>" title="click for edit" onclick="return confirm('Anda yakin untuk mengedit ?')"><span class="glyphicon glyphicon-edit"></span></a></div></td>
                            <td bgcolor=" #ffffff"><div><a class="btn btn-danger" href="hapusadmin.php?idAdmin=<?=$idAdmin?>" title="click for delete" onclick="return confirm('Anda yakin untuk menghapus ?')"><span class="glyphicon glyphicon-remove-circle"></span></a></div></td>
                        </tr>
                        <?php  
                    }
                }
