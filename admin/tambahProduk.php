...
include "koneksi.php";
 ...
 $query = "SELECT * FROM produk"; // Query untuk menampilkan semua data 
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           ...
           <nav class="navbar navbar-default">
            ...
            <div class="row">
                <!-- Welcome -->
<form action="simpanTambahProduk.php" method="post" name="form2" enctype="multipart/form-data" />
<table border="0" align="center">


<tr>
<td><input type="text" name="idProduk" value="" hidden=" "/></td>
</tr>
<tr>
...
<tr>
    ...
    <td><p>:</p></td>
    <td><p><input class="form-control" type="text" name="namaProduk" size="20"  /></p></td>
</tr>
<tr>
    <td><p>Keterangan</p></td>
    <td><p>:</p></td>
      <td><p><textarea class="form-control" type="text" name="ketProduk" size="20"></textarea></p></td>
</tr>
<tr>
    <td><p>Gambar</p></td>
    <td><p>:</p></td>
    <td><p><input type="file" name="fotoProduk"  /></p></td>
</tr>
